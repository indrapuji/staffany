...
import {createShifts, getShiftById, updateShiftById} from '../helper/api/shift';
...
const ShiftForm = () => {
  ...
  useEffect(() => {
    if (currentData !== null) {
      const startTime = format(new Date(), 'yyyy-MM-dd') + ' ' + currentData.startTime;
      const endTime = format(new Date(), 'yyyy-MM-dd') + ' ' + currentData.endTime;
